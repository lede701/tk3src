...
namespace Framework.Data.Migrations
{
    ...
    [Migration("20210315152730_AddingVotes")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Entities.Structure.IssueCommentVotes", b =>
                {
                    ...
                    b.HasKey("UserGuid", "CommentGuid");

                    b.ToTable("IssueCommentVotes");
                });

            modelBuilder.Entity("Core.Entities.Structure.IssueComments", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Core.Entities.Structure.IssueComments", b =>
                {
                    b.HasOne("Core.Entities.Structure.Issue", null)
                        .WithMany("Comments")
